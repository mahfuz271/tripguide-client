            ...
            <div className="container">
                <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between">
                    ...
                    <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0 main_menu">
                        ...
                        {user ? <><li><NavLink to="/addService" className={(({ isActive }) => isActive ? activeClassName : inActiveClass)} end>Add Service</NavLink></li>
                            <li><NavLink to="/ManageServices" className={(({ isActive }) => isActive ? activeClassName : inActiveClass)} end>Manage Services</NavLink></li>
                            <li><NavLink to="/MyReviews" className={(({ isActive }) => isActive ? activeClassName : inActiveClass)} end>My Reviews</NavLink></li>
                        </> : ''}
